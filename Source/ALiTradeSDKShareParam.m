...
- (instancetype)init {
    ...
    if (self) {
        ...
        //adzoneid不为空的情况回归
        self.taoKeParams = [[NSMutableDictionary alloc]initWithObjectsAndKeys:@"mm_116920901_33754200_136804813", @"pid",@"",@"unionId",@"", @"subPid", @"136804813",@"adzoneId",@{@"taokeAppkey":@"24549290"},@"extParams",nil];
        self.globalTaoKeParams = [[NSMutableDictionary alloc]initWithObjectsAndKeys:@"mm_116920901_33754200_136804813", @"pid",@"",@"unionId",@"", @"subPid",@"", @"adzoneId",nil];
